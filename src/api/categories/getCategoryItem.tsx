...
const getCategoryItem = async (type: CategoryType, filter?: any, isFilterId?: any, sortType?: any) => {
  ...
  const URL_API = `https://ninja-food-db.vercel.app/${type}?${categoryBy}&_sort=${orderBy}&_order=${order}`;
